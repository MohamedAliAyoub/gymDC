...
class FullEsxercisePlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'plans.*.exercises.*.exercise_details.*.previous' => 'required',
            'plans.*.exercises.*.exercise_details.*.rir' => 'required',
            'plans.*.exercises.*.exercise_details.*.tempo' => 'required',
            'plans.*.exercises.*.exercise_details.*.rest' => 'required',
